...
void PrintProgramPurpose() {
  ...
  std::cout << "Este programa sirve sumar los valores de un vector generado aleatoriamente" << std::endl << std::endl;
}
...
/**
  * @brief Esta función suma los valores de un vector
  *
  * @param vector Vector del que sumar los valores
  *
  * @return suma_valores_vector Suma de los valores del vector
  */

double SumaValoresVector(std::vector<double>& vector) {
