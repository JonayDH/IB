...
int main(int argc, char* argv[]) {
  ...
  double numero_minimo{};
  double numero_promedio{};
  ...
  MaximoMinimoPromedioVector(vector_generado, numero_maximo, numero_minimo, numero_promedio);
  std::cout << "Valor promedio del vector: " << numero_promedio << std::endl;
  std::cout << "Valor mínimo del vector: " << numero_minimo << std::endl;
  std::cout << "Valor máximo del vector: " << numero_maximo << std::endl;
