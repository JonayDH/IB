/**
  ...
  * @date Nov 22 2025
  * @brief Este programa crea un fichero cifrado a partir de otro fichero con un indice de cifrado que pone el usuario
...
int main(int argc, char* argv[]) {
  ...
  int indice_cifrado{std::stoi(argv[3])};

  CifrarFichero(fichero_entrada, fichero_salida, indice_cifrado);
