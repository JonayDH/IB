/**
  ...
  *
  * @file vocales_consonantes.cc
  * @author Jonay Déniz Hernández  alu0101791623@ull.edu.es
  * @date Nov 22 2025
  * @brief Este programa busca la palabra con más consonantes y la palabra con más vocales de un fichero de texto
...
int main(int argc, char* argv[]) {
  ...
  MaximoConsonantesVocales(nombre_fichero);
