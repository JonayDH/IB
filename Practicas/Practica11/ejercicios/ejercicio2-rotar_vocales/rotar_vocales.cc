/**
  ...
  *
  * @file rotar_vocales.cc
  * @author Jonay Déniz Hernández  alu0101791623@ull.edu.es
  * @date Nov 22 2025
  * @brief Este programa crea un fichero nuevo a partir de otro fichero cambiando las vocales por su siguiente vocal
...
int main(int argc, char* argv[]) {
  ...
  RotarFichero(fichero_entrada, fichero_salida);
