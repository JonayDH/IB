...
void PrintProgramPurpose() {
  ...
  std::cout << "Este programa sirve hacer varias operaciones relacionadas con 2 puntos en un plano" << std::endl << std::endl;
}
...
bool CheckCorrectParameters(const int argc, char *argv[], const int kCorrectNumber) {
  ...
  if (argc != kCorrectNumber) {
    ...
    std::cout << "param1: " << "coordenada x del primer punto" << std::endl;
    std::cout << "param2: " << "coordenada y del primer punto" << std::endl;
    std::cout << "param3: " << "coordenada x del segundo punto" << std::endl;
    std::cout << "param4: " << "coordenada y del segundo punto" << std::endl;
    return false;
  }
