/**
  ...
  * @date Nov 9 2025
  * @brief Este programa modifica una cadena de caracteres de manera que
  *        las minúsculas sean consonantes y las mayúsculas vocales. 
...
int main(int argc, char* argv[]) {
  ...
  CapitalizeVowels(cadena_caracteres);
