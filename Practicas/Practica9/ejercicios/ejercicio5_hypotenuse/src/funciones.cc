...
void PrintProgramPurpose() {
  ...
  std::cout << "Este programa sirve para calcular la hipotenusa de un triángulo" << std::endl;
}
...
bool CheckCorrectParameters(const int argc, char *argv[], const int kCorrectNumber) {
  ...
  if (argc != kCorrectNumber) {
    ...
    std::cout << "param2: " << "numero mayor que 0" << std::endl;
    return false;
  }
...
/**
  * Esta función calcula la hipotenusa usando los dos catetos
  *
  * @param cateto1 Número real mayor que 0
  * @param cateto2 Número real mayor que 0
  *
  * @return hipotenusa Valor de la hipotenusa
  */
...
double Hipotenusa(double cateto1, double cateto2) {
  ...
  hipotenusa = ApproximateRoot((cateto1 * cateto1) + (cateto2 * cateto2));
